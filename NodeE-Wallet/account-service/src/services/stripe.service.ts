...
//       apiVersion: '2022-08-01', // Use the latest stable API version
//     });
//   }
...
//   async createPayout(amount: number, currency: string, destination: string): Promise<Stripe.Payout> {
//     try {
...
//   async createPaymentMethod(type: Stripe.PaymentMethodCreateParams.Type, card: Stripe.PaymentMethodCreateParams.Card): Promise<Stripe.PaymentMethod> {
//     try {
